...

{
    ...
    function integralRule(){
        ...
        //获取所有优惠劵
        $query = $this->db->where('state','1')->get('hf_shop_coupon');
    ...
    function editNewUser(){
        ...
        if($_POST){
            ...
            $log = array(
                ...
                "content" => $_SESSION['users']['username']."修改里了新人奖励配置",
                "create_time" => date('Y-m-d H:i:s'),
            ...
            echo "<script>alert('操作成功！');window.location.href='".site_url('/integral/Integral/integralRule')."'</script>";exit;
