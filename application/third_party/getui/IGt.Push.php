...
require_once('protobuf/pb_message.php');
require_once('igetui/IGt.Req.php');
require_once('igetui/IGt.Message.php');
require_once('igetui/IGt.AppMessage.php');
require_once('igetui/IGt.ListMessage.php');
require_once('igetui/IGt.SingleMessage.php');
require_once('igetui/IGt.Target.php');
require_once('igetui/template/IGt.BaseTemplate.php');
require_once('igetui/template/IGt.LinkTemplate.php');
require_once('igetui/template/IGt.NotificationTemplate.php');
require_once('igetui/template/IGt.TransmissionTemplate.php');
require_once('igetui/template/IGt.NotyPopLoadTemplate.php');
require_once('igetui/template/IGt.APNTemplate.php');
require_once('igetui/utils/GTConfig.php');
require_once('igetui/utils/HttpManager.php');
require_once('igetui/utils/ApiUrlRespectUtils.php');
require_once('igetui/utils/LangUtils.php');
